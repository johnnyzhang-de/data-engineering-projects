...
# that takes a list of payment dictionaries (each with multiple line items) 
# and returns a pandas DataFrame showing per user: user_id, total_payments, total_amount, avg_amount_per_payment, and top_category (most frequent).
